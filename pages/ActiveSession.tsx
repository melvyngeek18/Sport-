  ...
  return (
    <div className="flex-1 flex flex-col bg-background-dark p-4 pb-12">
      ...
      <div className="flex items-center justify-between py-2 mb-6">
        ...
        <h2 className="text-lg font-bold tracking-tight">Séance du Jour</h2>
      ...
      <div className="px-2">
        <h1 className="text-[28px] font-black leading-tight mb-1">Condition Opérationnelle</h1>
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-4">
        <div className="relative w-full aspect-[4/3] flex flex-col items-center justify-center rounded-3xl bg-surface-dark/50 border-2 border-primary/60 shadow-[0_0_40px_rgba(244,140,37,0.1)] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary/5 pointer-events-none"></div>
          
          <p className="text-text-secondary text-base font-bold uppercase tracking-[0.2em] mb-4">TRAVAIL</p>
          <div className="text-[110px] leading-none font-black tracking-tighter tabular-nums drop-shadow-xl">
            {formatTime(timeLeft)}
          </div>
      ...
      <div className="flex gap-4">
        <button 
          onClick={() => navigate('/')}
          className="flex-1 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center gap-2 font-black text-lg hover:bg-white/10 transition-colors"
        >
        ...
        <button 
          ...
          className="flex-[2] h-16 rounded-2xl bg-primary flex items-center justify-center gap-2 font-black text-lg text-background-dark shadow-xl shadow-primary/20 active:scale-95 transition-all"
        >
